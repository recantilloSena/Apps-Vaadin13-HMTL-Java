...
import com.javaup.ui.views.categorieslist.CategoriesList;
import com.javaup.ui.views.reviewslist.ReviewsList;
...
public class MainLayout extends Div
    ...
    public MainLayout() {
        ...
        RouterLink demoView = new RouterLink(null, DemoView.class);
        demoView.add(new Icon(VaadinIcon.AIRPLANE), new Text("Ejemplos"));
        demoView.addClassName("main-layout__nav-item");
        

        Div navigation = new Div(reviews, categories,demoView);
