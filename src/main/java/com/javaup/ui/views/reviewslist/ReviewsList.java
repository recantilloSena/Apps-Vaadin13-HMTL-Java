 ...
 * the License.
 */
package com.javaup.ui.views.reviewslist;
...
import com.javaup.backend.Review;
import com.javaup.backend.ReviewService;
import com.javaup.ui.MainLayout;
import com.javaup.ui.common.AbstractEditorDialog;
import com.javaup.ui.encoders.LocalDateToStringEncoder;
import com.javaup.ui.encoders.LongToStringEncoder;
import com.javaup.ui.views.reviewslist.ReviewsList.ReviewsModel;
...
public class ReviewsList extends PolymerTemplate<ReviewsModel> {
    ...
    public ReviewsList() {
        search.setPlaceholder("Buscar Chequeos");
        ...
        getElement().setProperty("reviewButtonText", "Nuevas Chequeos");
